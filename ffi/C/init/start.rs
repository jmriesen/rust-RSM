...
#[no_mangle]
pub unsafe extern "C" fn INIT_Start(
    ...
    let mut hbuf: [libc::c_int; 648] = [0; 648];
    let mut i: libc::c_int = 0;
    let mut n_gbd: u_int = 0;
    let mut addoff: libc::c_longlong = 0;
    let mut shar_mem_key: key_t = 0;
    let mut shar_mem_id: libc::c_int = 0;
    let mut sem_id: libc::c_int = 0;
    let mut sem_val: [u_short; 5] = [0; 5];
    let mut semvals: semun_t = semun { val: 0 };
    let mut share_size: libc::c_longlong = 0;
    let mut locksize: libc::c_int = 0;
    let mut sjlt_size: libc::c_long = 0;
    ...
    if jobs < 1 as libc::c_int as u_int || jobs > 512 as libc::c_int as u_int {
        fprintf(
            __stderrp,
            b"Invalid number of jobs %u - must be 1 to %d\n\0" as *const u8
    ...
    if gmb > 131072 as libc::c_int as u_int {
        fprintf(
            __stderrp,
            b"Global buffer size must not exceed %d MiB\n\0" as *const u8
                as *const libc::c_char,
    ...
    if rmb > 4095 as libc::c_int as u_int {
        fprintf(
            __stderrp,
            b"Routine buffer size must not exceed %d MiB\n\0" as *const u8
                as *const libc::c_char,
            4095 as libc::c_int,
        );
        return 22 as libc::c_int;
    ...
    locksize = (jobs * 16384 as libc::c_int as u_int) as libc::c_int;
    locksize = ((locksize - 1 as libc::c_int) / pagesize + 1 as libc::c_int) * pagesize;
    dbfd = open(file, 0x2 as libc::c_int);
    if dbfd == -(1 as libc::c_int) {
        fprintf(
            __stderrp,
            b"Open of database %s failed - %s\n\0" as *const u8 as *const libc::c_char,
            file,
            strerror(*__error()),
        );
        return *__error();
    ...
    if i < ::core::mem::size_of::<label_block>() as libc::c_ulong as libc::c_int {
        fprintf(
            __stderrp,
            b"Read of label block failed - %s\n\0" as *const u8 as *const libc::c_char,
            strerror(*__error()),
        );
        return *__error();
    }
    labelblock = hbuf.as_mut_ptr() as *mut label_block;
    if (*labelblock).db_ver as libc::c_int != 2 as libc::c_int {
        fprintf(
            __stderrp,
            b"Database is version %u, image requires version %d - start failed!!\n\0"
                as *const u8 as *const libc::c_char,
            (*labelblock).db_ver as libc::c_int,
            2 as libc::c_int,
        );
        if ((*labelblock).db_ver as libc::c_int) < 2 as libc::c_int {
            fprintf(
                __stderrp,
                b"Upgrade database to version %d by running the bin/upgrade script\n\0"
                    as *const u8 as *const libc::c_char,
                2 as libc::c_int,
            );
        }
    ...
    if (*labelblock).magic != 4155766917 as libc::c_uint {
        fprintf(
            __stderrp,
            b"Invalid RSM database (wrong magic) - start failed!!\n\0" as *const u8
                as *const libc::c_char,
        );
        return -(1 as libc::c_int);
    }
    shar_mem_key = ftok(file, 50 as libc::c_int);
    if shar_mem_key == -(1 as libc::c_int) {
        fprintf(
            __stderrp,
            b"Unable to access database file: %s - %s\n\0" as *const u8
                as *const libc::c_char,
            file,
            strerror(*__error()),
        );
    ...
    if shar_mem_id != -(1 as libc::c_int) {
        fprintf(
            __stderrp,
            b"RSM environment is already initialized.\n\0" as *const u8
                as *const libc::c_char,
        );
        return 17 as libc::c_int;
    }
    if addmb > 0 as libc::c_int as u_int {
        fprintf(
            __stderrp,
            b"Additional buffers for mounting volumes are not currently supported - start failed!!\n\0"
                as *const u8 as *const libc::c_char,
        );
        return -(1 as libc::c_int);
    }
    n_gbd = (gmb as libc::c_long * 1048576 as libc::c_int as libc::c_long
        / hbuf[3 as libc::c_int as usize] as libc::c_long) as u_int;
    ...
    printf(
        b"Creating share for %u job%s with %u MiB routine space,\n\0" as *const u8
            as *const libc::c_char,
        jobs,
        if jobs > 1 as libc::c_int as u_int {
    ...
    printf(
        b"%u MiB (%u) global buffers, %d KiB label/map space,\n\0" as *const u8
            as *const libc::c_char,
        gmb,
        n_gbd,
        hbuf[2 as libc::c_int as usize] / 1024 as libc::c_int,
    );
    printf(
        b"and %d KiB for the lock table.\n\0" as *const u8 as *const libc::c_char,
        locksize / 1024 as libc::c_int,
    );
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        let fresh0 = i;
        i = i + 1;
        sem_val[fresh0 as usize] = jobs as u_short;
    }
    semvals.array = sem_val.as_mut_ptr();
    sjlt_size = (::core::mem::size_of::<systab_struct>() as libc::c_ulong)
        .wrapping_add(
            (::core::mem::size_of::<u_int>() as libc::c_ulong)
                .wrapping_mul(
                    jobs.wrapping_sub(1 as libc::c_int as u_int) as libc::c_ulong,
                )
                .wrapping_mul(1 as libc::c_int as libc::c_ulong),
        )
        .wrapping_add(
            (::core::mem::size_of::<jobtab>() as libc::c_ulong)
                .wrapping_mul(jobs as libc::c_ulong),
        )
        .wrapping_add(locksize as libc::c_ulong) as libc::c_long;
    sjlt_size = ((sjlt_size - 1 as libc::c_int as libc::c_long)
        / pagesize as libc::c_long + 1 as libc::c_int as libc::c_long)
        * pagesize as libc::c_long;
    volset_size = (::core::mem::size_of::<vol_def>() as libc::c_ulong)
        .wrapping_add(hbuf[2 as libc::c_int as usize] as libc::c_ulong)
        .wrapping_add(
        ...
        .wrapping_add(hbuf[3 as libc::c_int as usize] as libc::c_ulong)
        .wrapping_add(
    ...
    share_size = sjlt_size as libc::c_longlong + volset_size;
    addoff = share_size;
    share_size = share_size
        + (addmb as libc::c_long * 1048576 as libc::c_int as libc::c_long)
            as libc::c_longlong;
    shar_mem_id = shmget(
        shar_mem_key,
        share_size as size_t,
        0o400 as libc::c_int | 0o200 as libc::c_int
            | 0o400 as libc::c_int >> 3 as libc::c_int
            | 0o200 as libc::c_int >> 3 as libc::c_int | 0o1000 as libc::c_int,
    );
    if shar_mem_id == -(1 as libc::c_int) {
        fprintf(
            __stderrp,
            b"Unable to create shared memory section - %s\n\0" as *const u8
                as *const libc::c_char,
            strerror(*__error()),
        );
        if *__error() == 22 as libc::c_int {
            fprintf(
                __stderrp,
                b"\tIncrease kern.sysv.shmmax and/or kern.sysv.shmall\n\0" as *const u8
                    as *const libc::c_char,
            );
        } else if *__error() == 12 as libc::c_int {
            fprintf(
                __stderrp,
                b"\tInsufficient shared memory remaining\n\0" as *const u8
                    as *const libc::c_char,
            );
        }
        return *__error();
    ...
    if sem_id < 0 as libc::c_int {
        fprintf(
            __stderrp,
            b"Unable to create semaphore set - %s\n\0" as *const u8
                as *const libc::c_char,
            strerror(*__error()),
        );
    ...
    i = semctl(sem_id, 0 as libc::c_int, 9 as libc::c_int, semvals);
    if i == -(1 as libc::c_int) {
        fprintf(
            __stderrp,
            b"Unable to clear semaphores - %s\n\0" as *const u8 as *const libc::c_char,
            strerror(*__error()),
        );
        shmctl(shar_mem_id, 0 as libc::c_int, &mut sbuf);
        semctl(sem_id, 0 as libc::c_int, 0 as libc::c_int, semvals);
        return *__error();
    }
    systab = shmat(
        shar_mem_id,
    ...
    if systab == -(1 as libc::c_int) as *mut libc::c_void as *mut systab_struct {
        fprintf(
            __stderrp,
            b"Unable to attach to systab correctly - %s\n\0" as *const u8
                as *const libc::c_char,
            strerror(*__error()),
        );
        shmctl(shar_mem_id, 0 as libc::c_int, &mut sbuf);
    ...
    printf(
        b"Systab attached at %lx [semid: %d  shmid: %d]\n\0" as *const u8
            as *const libc::c_char,
        systab as u_long,
        sem_id,
        shar_mem_id,
    );
    memset(systab as *mut libc::c_void, 0 as libc::c_int, share_size as libc::c_ulong);
    (*systab).address = systab as *mut libc::c_void;
    (*systab)
        .jobtab = &mut *((*systab).last_blk_used)
        .as_mut_ptr()
        .offset((jobs * 1 as libc::c_int as u_int) as isize) as *mut u_int
        as *mut jobtab;
    (*systab).maxjob = jobs;
    (*systab).start_user = getuid() as libc::c_int;
    (*systab).precision = 18 as libc::c_int;
    (*systab).historic = 1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int;
    (*systab)
        .lockstart = ((*systab).jobtab as *mut libc::c_char)
        .offset(
            (::core::mem::size_of::<jobtab>() as libc::c_ulong)
                .wrapping_mul(jobs as libc::c_ulong) as isize,
        ) as *mut libc::c_void;
    (*systab).locksize = locksize;
    (*systab).lockhead = 0 as *mut locktab;
    (*systab).lockfree = (*systab).lockstart as *mut locktab;
    (*(*systab).lockfree).fwd_link = 0 as *mut LOCKTAB;
    (*(*systab).lockfree).size = locksize;
    (*(*systab).lockfree).job = -(1 as libc::c_int) as libc::c_short;
    (*systab).addoff = addoff as u_long;
    (*systab)
        .addsize = (addmb as libc::c_long * 1048576 as libc::c_int as libc::c_long)
        as u_long;
    (*systab)
        .vol[0 as libc::c_int
        as usize] = (systab as *mut libc::c_char).offset(sjlt_size as isize)
        as *mut vol_def;
    (*(*systab).vol[0 as libc::c_int as usize])
        .vollab = ((*systab).vol[0 as libc::c_int as usize] as *mut libc::c_char)
        .offset(::core::mem::size_of::<vol_def>() as libc::c_ulong as isize)
        as *mut label_block;
    (*(*systab).vol[0 as libc::c_int as usize])
        .map = ((*(*systab).vol[0 as libc::c_int as usize]).vollab as *mut libc::c_char)
        .offset(::core::mem::size_of::<label_block>() as libc::c_ulong as isize)
        as *mut libc::c_void;
    (*(*systab).vol[0 as libc::c_int as usize])
        .first_free = (*(*systab).vol[0 as libc::c_int as usize]).map;
    (*(*systab).vol[0 as libc::c_int as usize])
        .gbd_head = ((*(*systab).vol[0 as libc::c_int as usize]).vollab
        as *mut libc::c_char)
        .offset(hbuf[2 as libc::c_int as usize] as isize) as *mut gbd;
    (*(*systab).vol[0 as libc::c_int as usize]).num_gbd = n_gbd;
    (*(*systab).vol[0 as libc::c_int as usize])
        .global_buf = &mut *((**((*systab).vol)
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize))
        .gbd_head)
        .offset(n_gbd as isize) as *mut GBD as *mut libc::c_void;
    (*(*systab).vol[0 as libc::c_int as usize])
        .zero_block = &mut *((**((*systab).vol)
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize))
    ...
    (*(*systab).vol[0 as libc::c_int as usize])
        .rbd_head = ((*(*systab).vol[0 as libc::c_int as usize]).zero_block
        as *mut libc::c_char)
        .offset(hbuf[3 as libc::c_int as usize] as isize) as *mut libc::c_void;
    (*(*systab).vol[0 as libc::c_int as usize])
        .rbd_end = (systab as *mut libc::c_char)
        .offset(share_size as isize)
        .offset(-((*systab).addsize as isize)) as *mut libc::c_void;
    (*(*systab).vol[0 as libc::c_int as usize]).shm_id = shar_mem_id;
    (*systab).sem_id = sem_id;
    (*(*systab).vol[0 as libc::c_int as usize]).map_dirty_flag = 0 as libc::c_int;
    ...
    i = read(
        dbfd,
        (*(*systab).vol[0 as libc::c_int as usize]).vollab as *mut libc::c_void,
        hbuf[2 as libc::c_int as usize] as size_t,
    ) as libc::c_int;
    if i < hbuf[2 as libc::c_int as usize] {
        fprintf(
            __stderrp,
    ...
    if (*(*(*systab).vol[0 as libc::c_int as usize]).vollab).clean as libc::c_int
        == 0 as libc::c_int
    {
        fprintf(
            __stderrp,
        ...
        (*(*systab).vol[0 as libc::c_int as usize]).upto = 1 as libc::c_int as u_int;
    } else {
        (*(*(*systab).vol[0 as libc::c_int as usize]).vollab)
            .clean = 1 as libc::c_int as u_char;
        (*(*systab).vol[0 as libc::c_int as usize]).map_dirty_flag = 1 as libc::c_int;
    }
    jobs = jobs / 10 as libc::c_int as u_int;
    if jobs < 2 as libc::c_int as u_int {
        jobs = 2 as libc::c_int as u_int;
    }
    if jobs > 20 as libc::c_int as u_int {
        jobs = 20 as libc::c_int as u_int;
    }
    (*(*systab).vol[0 as libc::c_int as usize]).num_of_daemons = jobs as libc::c_int;
    ...
    if (*systab).maxjob == 1 as libc::c_int as u_int {
        printf(
            b"WARNING: Single user, journaling not started.\n\0" as *const u8
                as *const libc::c_char,
        );
    } else if (*(*(*systab).vol[0 as libc::c_int as usize]).vollab).journal_requested
        as libc::c_int != 0
        && (*(*(*systab).vol[0 as libc::c_int as usize]).vollab)
            .journal_file[0 as libc::c_int as usize] as libc::c_int != 0
    {
        ...
        i = stat(
            ((*(*(*systab).vol[0 as libc::c_int as usize]).vollab).journal_file)
                .as_mut_ptr(),
            &mut sb,
        );
        if i < 0 as libc::c_int && *__error() != 2 as libc::c_int {
            fprintf(
                __stderrp,
                ...
                *__error() = 0 as libc::c_int;
                            ...
                            .wrapping_sub(1 as libc::c_int as libc::c_uint)
                {
                        ...
                        != ::core::mem::size_of::<off_t>() as libc::c_ulong
                    {
                        ...
                        jptr = lseek(
                            jfd,
                            (*(*systab).vol[0 as libc::c_int as usize]).jrn_next,
                            0 as libc::c_int,
                        );
                        if jptr != (*(*systab).vol[0 as libc::c_int as usize]).jrn_next {
                            fprintf(
                                __stderrp,
                            ...
                            if i < jj.size as libc::c_int {
                                close(jfd);
                                fprintf(
                                    __stderrp,
                                    b"Journal file write failed - %s\n\0" as *const u8
                                        as *const libc::c_char,
                                    strerror(*__error()),
                                );
                                return *__error();
    ...
    gptr = (*(*systab).vol[0 as libc::c_int as usize]).gbd_head;
    ptr = (*(*systab).vol[0 as libc::c_int as usize]).global_buf as *mut u_char;
    let mut j: u_int = 0 as libc::c_int as u_int;
    while j < (*(*systab).vol[0 as libc::c_int as usize]).num_gbd {
        let ref mut fresh1 = (*gptr.offset(j as isize)).mem;
        *fresh1 = ptr as *mut DB_Block;
        ptr = ptr
            .offset(
                (*(*(*systab).vol[0 as libc::c_int as usize]).vollab).block_size as isize,
            );
        if j
            < ((*(*systab).vol[0 as libc::c_int as usize]).num_gbd)
                .wrapping_sub(1 as libc::c_int as u_int)
        {
            let ref mut fresh2 = (*gptr.offset(j as isize)).next;
            *fresh2 = &mut *gptr
                .offset(j.wrapping_add(1 as libc::c_int as u_int) as isize) as *mut gbd;
        } else {
            let ref mut fresh3 = (*gptr.offset(j as isize)).next;
            *fresh3 = 0 as *mut GBD;
        }
        j = j.wrapping_add(1);
        j;
    ...
    (*(*systab).vol[0 as libc::c_int as usize])
        .gbd_hash[1024 as libc::c_int as usize] = gptr;
    Routine_Init(0 as libc::c_int);
    shmdt(systab as *const libc::c_void);
    close(dbfd);
    printf(b"RSM environment initialized.\n\0" as *const u8 as *const libc::c_char);
