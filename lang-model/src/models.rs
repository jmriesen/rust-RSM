...
#[derive(Clone)]
pub enum KillArgChildren<'a> {
    KillExclusive(KillExclusive<'a>),
    KillInclusive(KillInclusive<'a>),
}
impl<'a> KillArgChildren<'a> {
    fn create(node: Node<'a>) -> Self {
        match node.kind() {
            "KillExclusive" => Self::KillExclusive(KillExclusive::create(node)),
            "KillInclusive" => Self::KillInclusive(KillInclusive::create(node)),
            _ => unreachable!(),
        }
    }
}
impl<'a> KillArg<'a> {
    pub fn children(&self) -> KillArgChildren<'a> {
        let mut cursur = self.node.walk();
        #[allow(unused_mut)]
        let mut children = self
            .node
            .named_children(&mut cursur)
            .map(KillArgChildren::create);
        children.next().unwrap()
    }
}
#[derive(Clone)]
...
impl<'a> KillCommand<'a> {
    pub fn children(&self) -> Kill<'a> {
        let mut cursur = self.node.walk();
        #[allow(unused_mut)]
        let mut children = self.node.named_children(&mut cursur).map(Kill::create);
        children.next().unwrap()
    }
}
impl<'a> KillCommand<'a> {
    pub fn args(&self) -> Vec<KillArg<'a>> {
        let mut cursur = self.node.walk();
        #[allow(unused_mut)]
        let mut children = self
            .node
...
#[derive(Clone)]
pub struct KillExclusive<'a> {
    node: Node<'a>,
}
impl<'a> KillExclusive<'a> {
    fn create(node: Node<'a>) -> Self {
        Self { node }
    }
    pub fn node(&self) -> &Node<'a> {
...
#[derive(Clone)]
pub struct KillInclusive<'a> {
    node: Node<'a>,
}
impl<'a> KillInclusive<'a> {
    fn create(node: Node<'a>) -> Self {
        Self { node }
    }
    pub fn node(&self) -> &Node<'a> {
...
impl<'a> commandChildren<'a> {
    fn create(node: Node<'a>) -> Self {
        match node.kind() {
            ...
            "KillCommand" => Self::KillCommand(KillCommand::create(node)),
...
impl<'a> line<'a> {
    pub fn level(&self) -> Vec<line_level2<'a>> {
        let mut cursur = self.node.walk();
        #[allow(unused_mut)]
        let mut children = self
            .node
            .children_by_field_name("level", &mut cursur)
            .filter(|x| x.is_named())
            .map(line_level2::create);
        children.collect()
    }
}
impl<'a> line<'a> {
    pub fn commands(&self) -> Option<commands<'a>> {
        let mut cursur = self.node.walk();
        #[allow(unused_mut)]
        let mut children = self
            .node
            .children_by_field_name("commands", &mut cursur)
            .filter(|x| x.is_named())
            .map(commands::create);
        children.next()
    }
...
#[derive(Clone)]
pub struct line_level2<'a> {
    node: Node<'a>,
}
impl<'a> line_level2<'a> {
    fn create(node: Node<'a>) -> Self {
        Self { node }
    }
    pub fn node(&self) -> &Node<'a> {
...
impl<'a> source_file<'a> {
    pub fn children(&self) -> Vec<line<'a>> {
        let mut cursur = self.node.walk();
        #[allow(unused_mut)]
        let mut children = self.node.named_children(&mut cursur).map(line::create);
        children.collect()
    }
}
#[derive(Clone)]
